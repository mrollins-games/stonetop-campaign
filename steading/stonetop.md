# The Steading of Stonetop

## Core Stats

| Stat | Starting | Current | Notes |
|------|----------|---------|-------|
| **Size** | Village (150–350) | Village | — |
| **Population** | +0 | +0 | — |
| **Prosperity** | +0 | +0 | — |
| **Defenses** | +0 | +0 | — |
...
- [ ] **Lacking** — due to shortages/hoarding/distrust (treat Prosperity as 1 lower)
- [ ] **Malcontent** — from fear/anger/despair (Fortunes resets to +0, not +1; folks need Persuading more)
...
## Assets
*Owned by residents in common. Must Requisition to take on expedition.*

- A pair of hardy draft horses (HP 10 each; d6+3 hand/close/forceful; Instinct: to panic)
...
## Places of Interest (Map Key)
| Key | Place | Notes |
|-----|-------|-------|
| A | The Stone | — |
| B | The Granary | — |
| C | Public House & Stables | — |
| D | Cistern | — |
| E | Pavilion of the Gods | — |
| F | Watchtowers (×3) | — |
| G | — | *To be named* |
| H | — | *To be named* |
| I | — | *To be named* |
...
## Content Safety
### Excluded Content (not part of the game)
- 

### Veiled Content (off-camera only)
- 
